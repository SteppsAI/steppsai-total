  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:mt-4 md:peer-data-[variant=inset]:mb-0 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-tl-2xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
        className
      )}
      {...props}
    />
