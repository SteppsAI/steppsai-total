                        ...
                        <div className="space-y-6">
                            ...
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-xs uppercase">
                                    <span className="bg-background px-2 text-zinc-500 font-medium rounded-full">
                                        Or continue with email
                                    </span>
                                </div>
                            </div>

                            <LoginForm isLogin={isLogin} from={from} />
                        </div>
                        ...
                        <div className="mt-8 pt-6 border-t border-zinc-200/50 text-center">
                            <p className="text-sm text-zinc-600">
                                ...
                                <button
                                    ...
                                    className="font-semibold text-primary hover:text-primary/80 transition-colors ml-1 hover:underline underline-offset-4"
                                >
