...
> **Laatste update:** Query caching & invalidation gefixed
...
## ✅ Correcte Query Key Invalidation

```tsx
// ❌ FOUT (werkte niet)
queryClient.invalidateQueries({ queryKey: ["guides"] });

// ✅ GOED (tRPC v11 query keys)
const guidesQueryKey = trpc.guides.getAll.queryOptions().queryKey;
queryClient.invalidateQueries({ queryKey: guidesQueryKey });
```
