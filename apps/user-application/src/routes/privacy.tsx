          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                Welcome to stepps.ai. We respect your privacy and are committed
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed mt-4">
                    When using the Stepps.ai browser extension, users may choose
                    to record workflows that include screenshots, page URLs,
                    and interaction data. These screenshots may incidentally
                    contain personal or sensitive information visible on the
                    recorded webpages, depending on what the user chooses to
                    record. Stepps.ai does not intentionally collect, process,
                    or extract authentication credentials, passwords, or other
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    features. You can control cookies through your browser
                    settings.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    good faith belief that such action is necessary to comply
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                ...
                for the purposes outlined in this policy, unless a longer
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    For EU users, we comply with the General Data Protection
                    Regulation (GDPR). Our legal basis for processing includes
                    consent, contractual necessity, legitimate interests, and
                    legal obligations.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    Consumer Privacy Act (CCPA), granting you specific rights
                    regarding your personal information.
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <div className="space-y-2">
                <p className="text-gray-600">
                  Support: support@stepps.ai
                </p>
                <p className="text-gray-600">
                  Website: https://stepps.ai
                </p>
              </div>
            </section>
          </div>
